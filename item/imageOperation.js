...
lt_code.image.convolutionKernel3 = class {
     ...
     */
    setImageData(x, y, imageData) {
        lt_code.image.ctx.putImageData(imageData, x, y);
    }
    ...
    handleOut() {
         ...
         */
        var getColor2 = (x, y) => {
            x += lt_code.image.constant.startX;
            y += lt_code.image.constant.startY;
            return this.getImageData(x, y, 1, 1);
        }
         ...
         * @param {any} a
         */
        var setColor2 = (x, y, r, g, b, a) => {
            x += lt_code.image.constant.startX;
            y += lt_code.image.constant.startY + lt_code.image.constant.height / 2;
            var temp = [r, g, b, a];
            temp = new Uint8ClampedArray(temp);
            temp = new ImageData(temp,1,1);
            lt_code.image.ctx.putImageData(temp,x,y);
        }
        ...
        for (var i = 0; i < line; i++) {
            for (var j = 0; j < list; j++) {
                var p1 = getColor2(i - 1, j - 1),
                    p2 = getColor2(i - 1, j),
                    p3 = getColor2(i - 1, j + 1),
                    p4 = getColor2(i, j - 1),
                    p5 = getColor2(i, j),
                    p6 = getColor2(i, j + 1),
                    p7 = getColor2(i + 1, j - 1),
                    p8 = getColor2(i + 1, j),
                    p9 = getColor2(i + 1, j + 1);

                var r = function () {
                    var ret = p1.data[0] * base.points[0][0];
                    ret += p2.data[0] * base.points[0][1];
                    ret += p3.data[0] * base.points[0][2];
                    ret += p4.data[0] * base.points[1][0];
                    ret += p5.data[0] * base.points[1][1];
                    ret += p6.data[0] * base.points[1][2];
                    ret += p7.data[0] * base.points[2][0];
                    ret += p8.data[0] * base.points[2][1];
                    ret += p9.data[0] * base.points[2][2];
                    return Math.round(ret / 9);
                }(), g = function () {
                    var ret = p1.data[1] * base.points[0][0];
                    ret += p2.data[1] * base.points[0][1];
                    ret += p3.data[1] * base.points[0][2];
                    ret += p4.data[1] * base.points[1][0];
                    ret += p5.data[1] * base.points[1][1];
                    ret += p6.data[1] * base.points[1][2];
                    ret += p7.data[1] * base.points[2][0];
                    ret += p8.data[1] * base.points[2][1];
                    ret += p9.data[1] * base.points[2][2];
                    return Math.round(ret / 9);
                }(), b = function () {
                    var ret = p1.data[2] * base.points[0][0];
                    ret += p2.data[2] * base.points[0][1];
                    ret += p3.data[2] * base.points[0][2];
                    ret += p4.data[2] * base.points[1][0];
                    ret += p5.data[2] * base.points[1][1];
                    ret += p6.data[2] * base.points[1][2];
                    ret += p7.data[2] * base.points[2][0];
                    ret += p8.data[2] * base.points[2][1];
                    ret += p9.data[2] * base.points[2][2];
                    return Math.round(ret / 9);
                }(), a = function () {
                    var ret = p1.data[3] * base.points[0][0];
                    ret += p2.data[3] * base.points[0][1];
                    ret += p3.data[3] * base.points[0][2];
                    ret += p4.data[3] * base.points[1][0];
                    ret += p5.data[3] * base.points[1][1];
                    ret += p6.data[3] * base.points[1][2];
                    ret += p7.data[3] * base.points[2][0];
                    ret += p8.data[3] * base.points[2][1];
                    ret += p9.data[3] * base.points[2][2];
                    return Math.round(ret / 9);
                }();
