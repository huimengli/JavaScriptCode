...
lt_code.watermark = {
     ...
     * 原图输入框
     */
    input : lt_code.newDom("input", {
        type: "file",
    }),

    /**生成二维码的canvas */
    codeCanvas : lt_code.newDom("canvas", {
        width: 32,
        height: 32,
        style: {
            zoom: 10,
    ...
    /**代码画布对象*/
    codeCtx : lt_code.getCtx(lt_code.newDom("canvas")),

    /**测试rgb和ycc互相转化 */
    testRGBandYCC : function () {
     ...
     */
    init : function (domFather) {
        domFather = domFather ? domFather : lt_code.getAll();
        this.codeCtx = lt_code.getCtx(this.codeCanvas);
